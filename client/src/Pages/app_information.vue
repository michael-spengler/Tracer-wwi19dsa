...
<div>
    <br>
    <img class="icon" src="@/assets/img/info-black-18dp.svg" height="80" alt="error picture not available"/>
    <p class=p_left>
  ...
  <img class="icon" src="@/assets/img/help-24px.svg" height="70" alt="error picture not available"/>
  ...
  <img class="icon" src="@/assets/img/storage-24px.svg" height="70" alt="error picture not available"/>
  ...
  <img class="icon" src="@/assets/img/qr_code-24px.svg" height="70" alt="error picture not available"/>
  ...
  <img class="icon" src="@/assets/img/groups-24px.svg" height="70" alt="error picture not available"/>
